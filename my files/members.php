                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-archive"></i><span>Project </span><span class="pull-right"><i class="md md-add"></i></span></a>
                            ...
                            <div class="col-lg-12">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>  php developer and UI designer</td>
                                    </tr>
                                     <tr>
                                        <td>4</td>
                                        <td>Sachin pandey</td>
