                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect active"><i class="fa fa-archive"></i><span>Project </span><span class="pull-right"><i class="md md-add"></i></span></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-lg-offset-1">
                                <div class="panel panel-color panel-primary">
                                    ...
                                    <div class="panel-body"> 
                                        <p>Sanchit Gupta (Team-leader)</p>
                                        <p>Rahul Thakur (Team-leader)</p>
                                        <p>Sachin (Team-member)</p>
                                        <p>Vishal Gupta (Team-member)</p> 
                                    </div> 
                                </div>
                            </div>
