...
<body>
<br /><br />
<form ACTION="<?php echo htmlspecialchars($loginFormAction); ?>"  name="login_form" METHOD="POST">
<div id="wrapper">

		<div align="center">
			<img src="images/dit.jpg" alt="dit" width="137" height="111" />		</div>
<br /><br />
...
<tr>
	...
	<td>
	  <tr>
			  <td class="F">College-Id:</td>
			  <td class="b"><input type="text" name="login" value="" placeholder="College-Id"></td>
	  </tr>
