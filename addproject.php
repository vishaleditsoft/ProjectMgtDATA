...
$proj_assign=$_POST['assign_mem'];
$members=implode(",",$proj_assign);
...
if(is_dir('upload/'.$manger_id))
 ...
 $addpro_query="insert into project(`project_name`,`project_manger_id`,`project_member_id`,`project_desc`,`assign_to`,`project_document`,`project_end_date`) values('$proj_name','$manger_id','$proj_mem_id','$proj_desc','$members','$destt','$proj_dead')";
